...
func (m *Manager) revoke(ctx context.Context, reason string) {
	...
	m.reportStatus(ctx, reqID, pb.AdminAccessStatus_ADMIN_ACCESS_STATUS_REVOKED, reason)
}

func (m *Manager) reportStatus(ctx context.Context, reqID string, status pb.AdminAccessStatus, details string) {
