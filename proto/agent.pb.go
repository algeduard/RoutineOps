...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\x16metrics_sample_seconds\x18\x02 \x01(\x03R\x14metricsSampleSeconds\"\xa0\x01\n" +
	...
	"\x13LOCK_MODE_FILEVAULT\x10\x022\xd9\v\n" +
	"\fAgentService\x12=\n" +
	...
	"\x11EscrowRecoveryKey\x12$.routineops.EscrowRecoveryKeyRequest\x1a%.routineops.EscrowRecoveryKeyResponse\x12Z\n" +
...
var file_proto_agent_proto_goTypes = []any{
	...
	(*ResourceSample)(nil),               // 40: routineops.ResourceSample
	(*ResourceMetricsReport)(nil),        // 41: routineops.ResourceMetricsReport
	(*ResourceMetricsAck)(nil),           // 42: routineops.ResourceMetricsAck
	(*AppUsageEntry)(nil),                // 43: routineops.AppUsageEntry
	(*DailyActivity)(nil),                // 44: routineops.DailyActivity
	(*AppUsageReport)(nil),               // 45: routineops.AppUsageReport
	(*AppUsageAck)(nil),                  // 46: routineops.AppUsageAck
	(*FetchTelemetryConfigRequest)(nil),  // 47: routineops.FetchTelemetryConfigRequest
	(*FetchTelemetryConfigResponse)(nil), // 48: routineops.FetchTelemetryConfigResponse
	(*ReportLockStatusRequest)(nil),      // 49: routineops.ReportLockStatusRequest
	(*ReportLockStatusResponse)(nil),     // 50: routineops.ReportLockStatusResponse
	(*FetchLockStatusRequest)(nil),       // 51: routineops.FetchLockStatusRequest
	(*FetchLockStatusResponse)(nil),      // 52: routineops.FetchLockStatusResponse
}
var file_proto_agent_proto_depIdxs = []int32{
	...
	40, // 18: routineops.ResourceMetricsReport.samples:type_name -> routineops.ResourceSample
	43, // 19: routineops.AppUsageReport.apps:type_name -> routineops.AppUsageEntry
	44, // 20: routineops.AppUsageReport.days:type_name -> routineops.DailyActivity
	8,  // 21: routineops.ReportLockStatusRequest.state:type_name -> routineops.LockState
	9,  // 22: routineops.FetchLockStatusResponse.lock_mode:type_name -> routineops.LockMode
	10, // 23: routineops.AgentService.Connect:input_type -> routineops.HeartbeatRequest
	20, // 24: routineops.AgentService.AckTaskReceived:input_type -> routineops.TaskReceivedAck
	13, // 25: routineops.AgentService.ReportInventory:input_type -> routineops.InventoryReport
	18, // 26: routineops.AgentService.ReportTaskResult:input_type -> routineops.TaskResult
	22, // 27: routineops.AgentService.ReportSecurityEvent:input_type -> routineops.SecurityEvent
	25, // 28: routineops.AgentService.FetchPolicy:input_type -> routineops.FetchPolicyRequest
	27, // 29: routineops.AgentService.RequestAdminAccess:input_type -> routineops.RequestAdminAccessRequest
	29, // 30: routineops.AgentService.FetchAdminStatus:input_type -> routineops.FetchAdminStatusRequest
	31, // 31: routineops.AgentService.ReportAdminAccess:input_type -> routineops.ReportAdminAccessRequest
	34, // 32: routineops.AgentService.FetchScriptPolicies:input_type -> routineops.FetchScriptPoliciesRequest
	36, // 33: routineops.AgentService.ReportScriptResult:input_type -> routineops.ScriptResult
	49, // 34: routineops.AgentService.ReportLockStatus:input_type -> routineops.ReportLockStatusRequest
	51, // 35: routineops.AgentService.FetchLockStatus:input_type -> routineops.FetchLockStatusRequest
	38, // 36: routineops.AgentService.EscrowRecoveryKey:input_type -> routineops.EscrowRecoveryKeyRequest
	41, // 37: routineops.AgentService.ReportResourceMetrics:input_type -> routineops.ResourceMetricsReport
	45, // 38: routineops.AgentService.ReportAppUsage:input_type -> routineops.AppUsageReport
	47, // 39: routineops.AgentService.FetchTelemetryConfig:input_type -> routineops.FetchTelemetryConfigRequest
	15, // 40: routineops.AgentService.Connect:output_type -> routineops.Task
	21, // 41: routineops.AgentService.AckTaskReceived:output_type -> routineops.TaskReceivedAckResponse
	14, // 42: routineops.AgentService.ReportInventory:output_type -> routineops.InventoryAck
	19, // 43: routineops.AgentService.ReportTaskResult:output_type -> routineops.TaskResultAck
	23, // 44: routineops.AgentService.ReportSecurityEvent:output_type -> routineops.SecurityEventAck
	26, // 45: routineops.AgentService.FetchPolicy:output_type -> routineops.FetchPolicyResponse
	28, // 46: routineops.AgentService.RequestAdminAccess:output_type -> routineops.RequestAdminAccessResponse
	30, // 47: routineops.AgentService.FetchAdminStatus:output_type -> routineops.FetchAdminStatusResponse
	32, // 48: routineops.AgentService.ReportAdminAccess:output_type -> routineops.ReportAdminAccessResponse
	35, // 49: routineops.AgentService.FetchScriptPolicies:output_type -> routineops.FetchScriptPoliciesResponse
	37, // 50: routineops.AgentService.ReportScriptResult:output_type -> routineops.ScriptResultAck
	50, // 51: routineops.AgentService.ReportLockStatus:output_type -> routineops.ReportLockStatusResponse
	52, // 52: routineops.AgentService.FetchLockStatus:output_type -> routineops.FetchLockStatusResponse
	39, // 53: routineops.AgentService.EscrowRecoveryKey:output_type -> routineops.EscrowRecoveryKeyResponse
	42, // 54: routineops.AgentService.ReportResourceMetrics:output_type -> routineops.ResourceMetricsAck
	46, // 55: routineops.AgentService.ReportAppUsage:output_type -> routineops.AppUsageAck
	48, // 56: routineops.AgentService.FetchTelemetryConfig:output_type -> routineops.FetchTelemetryConfigResponse
