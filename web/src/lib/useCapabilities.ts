...
const EMPTY: Capabilities = { software_removal: false, siem_export: false, audit_integrity: false, sso: false, compliance: false, cve_scan: false, multitenancy: false, scim: false, alert_routing: false, reports: false, policy_as_code: false, auto_remediation: false }
